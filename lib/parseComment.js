      ...
      switch (tag.title) {
        ...
        case "typedef":
          return {
            ...result,
            typedef:
              tag.type && tagTypeToTSType(tag.type, result.templates, true)
          };
        ...
        case "param": {
          ...
          if (tag.type && isTagTypeRest(tag.type)) {
            ...
            param.typeAnnotation =
              tag.type && tagTypeToAnnotation(tag.type, result.templates);
          } else {
        ...
        case "return":
          return {
            ...result,
            return: tag.type
              ? tagTypeToAnnotation(tag.type, result.templates)
              : null
          };
        ...
        case "type":
          return {
            ...result,
            type: tag.type && tagTypeToAnnotation(tag.type, result.templates)
          };
        ...
        case "enum":
          return tag.type
            ? {
                ...result,
                enum: tagTypeToTSType(tag.type, result.templates)
              }
            : result;
